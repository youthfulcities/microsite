  ...
  const cardSets = {
    ...
    'JAN 30': [
      ...
      },
      {
        ...
        speaker: 'John Smith',
        description:
          'A data-driven workshop utilizes pre-summit information and resources for collaborative group work, defining the current state of work and opportunities.',
        color: '#F2695D',
      },
      {
        title: 'Lunch Break',
